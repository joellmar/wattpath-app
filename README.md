...
La memoria técnica en español está preparada para usarse como anexo del proyecto final:

* [Memoria final del proyecto](docs/memoria/memoria-final-daw.md)
...
* [Anexo C: Ingesta MQTT con Spring Integration](docs/memoria/anexo-c-telemetria-mqtt.md)
