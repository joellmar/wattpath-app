...
La memoria final y sus anexos técnicos están organizados en Markdown para poder
usarlos directamente en la entrega del proyecto:

* [Memoria técnica final](docs/memoria/memoria-final-daw.md)
...
* [Anexo C — Telemetría MQTT y simulación IoT](docs/memoria/anexo-c-telemetria-mqtt.md)
