...
El diagrama marca `devices.user_id` como opcional porque el backend permite
dispositivos físicos no reclamados. La relación con `readings` también es
cero-a-muchas: el dispositivo existe antes de que llegue su primera muestra.
